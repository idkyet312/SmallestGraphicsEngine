#ifndef CLUSTERED_RENDERER_DX11_H
#define CLUSTERED_RENDERER_DX11_H
...
// Point light data structure for shader
...
struct PointLight {
    ...
    PointLight() : position(XMFLOAT3(0,0,0)), radius(10.0f), color(XMFLOAT3(1,1,1)), intensity(1.0f),
